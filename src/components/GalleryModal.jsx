...
export default function GalleryModal({ isOpen, images, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-[#0f172a]/95 backdrop-blur-md flex flex-col items-center justify-center">
      <button
        onClick={onClose}
        className="absolute top-6 right-6 text-white/50 hover:text-white z-[100] p-2 hover:bg-white/10 rounded-full"
      >
        <X size={24} />
      </button>
      ...
      <div className="absolute bottom-10 px-5 py-2 bg-black/60 text-white rounded-full text-xs font-bold tracking-widest border border-white/10">
